...
type AnalysisTaskCameraAlgorithmSearchReq struct {
	g.Meta      `path:"/analysisTaskCameraAlgorithm/list" tags:"分析任务摄像头算法关联管理" method:"get" summary:"分析任务摄像头算法关联列表"`
...
type AnalysisTaskCameraAlgorithmAddReq struct {
	g.Meta      `path:"/analysisTaskCameraAlgorithm/add" tags:"分析任务摄像头算法关联管理" method:"post" summary:"添加分析任务摄像头算法关联"`
...
type AnalysisTaskCameraAlgorithmEditReq struct {
	g.Meta      `path:"/analysisTaskCameraAlgorithm/edit" tags:"分析任务摄像头算法关联管理" method:"put" summary:"修改分析任务摄像头算法关联"`
...
type AnalysisTaskCameraAlgorithmDeleteReq struct {
	g.Meta `path:"/analysisTaskCameraAlgorithm/delete" tags:"分析任务摄像头算法关联管理" method:"delete" summary:"删除分析任务摄像头算法关联"`
	Ids    []uint `p:"ids"`
}
