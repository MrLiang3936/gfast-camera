...
type ISysConfig interface {
	...
	//////////////////////////////////////////
	// 网络配置相关接口
	GetNetworkConfig(ctx context.Context, nicName string) (res *system.NetworkConfigGetRes, err error)
	SaveNetworkConfig(ctx context.Context, req *system.NetworkConfigSaveReq, userId uint64) (err error)
	GetNetworkList(ctx context.Context) (res *system.NetworkListRes, err error)
}
