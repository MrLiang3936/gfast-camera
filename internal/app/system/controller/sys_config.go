...
func (c *configController) GetNetworkConfig(ctx context.Context, req *system.NetworkConfigGetReq) (res *system.NetworkConfigGetRes, err error) {
	res, err = commonService.SysConfig().GetNetworkConfig(ctx, req.NicName)
	return
}

// SaveNetworkConfig 保存网络配置
func (c *configController) SaveNetworkConfig(ctx context.Context, req *system.NetworkConfigSaveReq) (res *system.NetworkConfigSaveRes, err error) {
	err = commonService.SysConfig().SaveNetworkConfig(ctx, req, service.Context().GetUserId(ctx))
	return
}

// GetNetworkList 获取网卡列表
func (c *configController) GetNetworkList(ctx context.Context, req *system.NetworkListReq) (res *system.NetworkListRes, err error) {
	res, err = commonService.SysConfig().GetNetworkList(ctx)
	return
}
